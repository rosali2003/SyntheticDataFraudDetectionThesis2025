...
def train_and_evaluate(fraud_rate=0.2, n_samples=1000, epochs=100, learning_rate=0.01):
    """
    Train single-layer neural network model and evaluate performance metrics
    ...
    # Initialize model
    model = SingleLayerNet(input_size=len(features))
