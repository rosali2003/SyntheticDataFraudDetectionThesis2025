...
# Function to evaluate traditional models
def evaluate_traditional_model(name, y_true, y_pred):
...
if __name__ == "__main__":
    ...
    # Convert regression output to binary predictions using 0.5 threshold
